...
-- Listage des données de la table cinemadl8.acteur : ~16 rows (environ)
/*!40000 ALTER TABLE `acteur` DISABLE KEYS */;
REPLACE INTO `acteur` (`id_acteur`, `nom_acteur`, `prenom_acteur`, `date_naissance_acteur`, `sexe_acteur`) VALUES
...
REPLACE INTO `casting` (`id_film`, `id_role`, `id_acteur`) VALUES
	(3, 1, 1),
	(8, 4, 4),
	(6, 5, 5),
	(7, 6, 5),
...
-- Listage des données de la table cinemadl8.film : ~35 rows (environ)
/*!40000 ALTER TABLE `film` DISABLE KEYS */;
REPLACE INTO `film` (`id_film`, `titre_film`, `annee_film`, `duree_film`, `resume_film`, `note_film`, `url_image`, `id_realisateur`) VALUES
	...
	(6, 'Drive', 2011, 103, 'Un jeune homme solitaire, "The Driver", conduit le jour à Hollywood pour le cinéma en tant que cascadeur et la nuit pour des truands. Ultra professionnel et peu bavard, il a son propre code de conduite. Jamais il n’a pris part aux crimes de ses employeurs autrement qu’en conduisant - et au volant, il est le meilleur !', 5, 'https://lh3.googleusercontent.com/proxy/ZsrS7jpGpIVbkdNRgsF52rUkZ1oep9lpkOzmWrkfMad-yp_ENnCmgjjlhFipM-BQo8fzt4fM8ztNAOnZs58QQVuN7ol4fy-z_2LQYi9RKyl55WX-lBkVvC1umTHPiydAxx5e1WjZoLZHlAYPbXHJiYnwgbzl4KOKaRqvVuIld8EO', 5),
	...
	(28, 'Beetlejuice', 1988, 92, NULL, 4, 'https://idata.over-blog.com/2/80/11/49//article-beetlejuice.jpg', 22),
	(29, 'Mars Attacks!', 1996, 106, NULL, 3, 'https://medias.spotern.com/spots/w640/77/77423-1532336916.jpg', 22),
	(30, 'Big Fish', 2004, 125, 'L\'histoire à la fois drôle et poignante d\'Edward Bloom, un père débordant d\'imagination, et de son fils William. Ce dernier retourne au domicile familial après l\'avoir quitté longtemps auparavant, pour être au chevet de son père, atteint d\'un cancer. Il souhaite mieux le connaître et découvrir ses secrets avant qu\'il ne soit trop tard. L\'aventure débutera lorsque William tentera de discerner le vrai du faux dans les propos de son père mourant.', 4, 'https://fr.web.img6.acsta.net/videothumbnails/14/03/05/13/14/395860.jpg', 22),
...
-- Listage des données de la table cinemadl8.genre : ~12 rows (environ)
...
-- Listage des données de la table cinemadl8.genre_film : ~0 rows (environ)
/*!40000 ALTER TABLE `genre_film` DISABLE KEYS */;
REPLACE INTO `genre_film` (`id_genre`, `id_film`) VALUES
	(2, 2),
	(2, 3),
	(1, 4),
	(2, 4),
...
-- Listage des données de la table cinemadl8.realisateur : ~0 rows (environ)
/*!40000 ALTER TABLE `realisateur` DISABLE KEYS */;
REPLACE INTO `realisateur` (`id_realisateur`, `nom_realisateur`, `prenom_realisateur`) VALUES
	(1, 'Spielberg', 'Steven'),
	(2, 'Uthaug', 'Roar'),
	(3, 'Coogler', 'Ryan'),
	(4, 'Miller', 'Georges'),
...
-- Listage des données de la table cinemadl8.role : ~0 rows (environ)
