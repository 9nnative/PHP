...
<head>
    ...
    <!-- Local CSS -->
    <link rel="stylesheet" href="C:\Users\coren\Documents\GitHub\PHP\Exercices\Forum\ForumMVC\public\css\stylesheet.css"/>
    <!-- UIkit JS -->
    ...
    <nav class="uk-navbar-container uk-background-secondary uk-light" uk-navbar>
        <div class="uk-navbar-left">
            <ul class="uk-navbar-nav">
                <li><a id="home" href="?ctrl=home&method=index"><span uk-icon='home'></span>&nbsp;Accueil</a></li>
            </ul>
        </div>
    </nav>
